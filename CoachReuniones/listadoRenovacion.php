...
<body>
  <a type="button" class="btn btn-primary" href="renovaciones2.php" style="float: right;margin-right: 113px;">
    No Recibidas
  </a>
  <br>
  <div class="container" style="background: #343A40;color: white;margin-top: 20px;border-radius: 20px;text-align: center;">
    <table id="example" class="table ">

      <thead style="background-color:#be0032;">
        <tr>
          <th>ID Renovacion</th>
          <th>ID Alumno</th>
          <th>Alumno</th>
      ...
      <tbody style="color: black;" class="table-hover table-striped table-bordered">
        <?php
        $sql = "SELECT idRenovacion,renovacion.Estado,renovacion.tipo,renovacion.ID_Alumno,alumnos.Nombre as 'alumno',carrera.nombre as 'carrera',empresas.Nombre as 'uni',ciclo,year,direccion,alumnos.ID_Sede AS 'sede',alumnos.Class
          FROM renovacion JOIN alumnos ON alumnos.ID_Alumno = renovacion.ID_Alumno JOIN carrera ON carrera.Id_Carrera = alumnos.ID_Carrera   JOIN empresas ON empresas.ID_Empresa = alumnos.ID_Empresa   WHERE renovacion.Estado != 'eliminado'";
