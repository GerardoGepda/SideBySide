...
if (isset($_POST['pdfNotas'])) {
    ...
    $consulta2 = $pdo->prepare("SELECT pdfnotas FROM inscripcionciclos   WHERE Id_InscripcionC = :Id_InscripcionC");
    ...
    if ($tama«Ðoarchivo <= 5000000) {
        ...
        if (copy($rutaarchivo, $destino)) {
            ...
            $consulta = $pdo->prepare("UPDATE `inscripcionciclos` SET `pdfnotas`= :pdfnotas  WHERE `Id_InscripcionC` = :Id_InscripcionC ");
