...
$stmt9 = $dbh->prepare("SELECT comprobante , cicloU, Id_InscripcionC , pdfnotas FROM `inscripcionciclos` WHERE `idExpedienteU` = ?");
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item" id="bloque">
                <a class="nav-link" href="pensum.php?id=<?php echo $id ?>">Pensum<span
...
<div class="container-fluid text-center">
    <div class="row  mt-2" id="detalles">
        <div class="text-center align-self-center ml-5 " id="carnet" style="background-color:  #c7c7c7;">
            <br>
            <img v-bind:src="'../img/imgUser/'+datos.imagen" alt="img de usuario"
                style="height: 170px; width: 170px; background-repeat: no-repeat; background-position: 50%; border-radius: 50%; background-size: 100% auto;">
    ...
    <div class="card text-center" style=" border-color: white;border-width: 3px;border-style: solid;">
        ...
        <div class="card-body" style="background-color: white; ">
                ...
                <table class="table table-responsive-lg float-left">
                    ...
                    <tbody id="estudio">
                        <tr class="table-dark text-dark ">
                            ...
                            <th scope="col" v-else> Debe actualizar </th>
                            <th scope="col">
                                <button type='button' class='btn btn-danger' data-toggle='modal' data-target='#pensum'
                                    style="border-radius: 20px; border: 2px solid #9d120e; width: 100px;height: 50px; background-color: #9d120e; color:white;"><img
                                        src="../img/add.png" width="25px" height="25px"><br>
                                    <p style="font-size: 10px;">Subir pensum</p>
                                </button>
                            </th>
                            <th scope="col" v-if="expedU.pensum "><a v-bind:href="'../pdfPensum/'+expedU.pensum"
                                    target='_blank' class='btn btn-danger '><img src='../img/PDF.png' width='25px'
                                        height='25px'></a></th>
                            <th scope="col" v-else><a v-bind:href="'../pdfPensum/'+expedU.pensum" target='_blank'
                                    class='btn btn-danger ' disabled><img src='../img/PDF.png' width='25px'
                                        height='25px'></a></th>
                            <th scope="col">
            ...
            <button type="button" class="btn btn-primary m-3" data-toggle="modal" data-target="#exampleModal">Agregar
                inscripción</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="../CoachReuniones/Modelo/ModeloMaterias/subirPdfCiclo.php" method="post"
            ...
            <div class="modal-footer">
                <input
                    style="border-radius: 20px;  border: 2px solid #9d120e; width: 100px;height: 38px;  background-color: #9d120e; color:white;"
                    type="submit" name="actualizar" value="Cerrar " data-dismiss="modal">
                <input
                    style="border-radius: 20px; border: 2px solid #9d120e; width: 200px;height: 38px;  background-color: #9d120e;   color:white;"
                    type="submit" name="comprobante_Ciclo" value="Guardar Cambios " id="comprobante_Ciclo">
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="formAlumno">
                <form class="w-50 mx-auto" method="post" action="Modelo/ModeloAlumno/actualizar.php">
                    <div class="form-group">
                        <label for="" class="text-dark">Hola <b> {{otros.Alumno}} </b> a continuación escriba los datos
                            que se solicitan:</label><br>
                        <label for="exampleInputEmail1" class="text-dark">CUM:</label>
                        <input type="number" step="0.1" min="0" max="10" name="cum" v-bind:value="universidad.cum"
                            class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="Ingrese su CUM">
                    </div>
                    <div class="form-group text-dark">
                        ...
                        <input type="text" name="carnet" v-bind:value="universidad.carnet" class="form-control"
                            id="exampleInputPassword1" placeholder="Ingrese su carnet">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" min="0" max="100" name="avance"
                            v-bind:value="universidad.avancePensum" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" placeholder="Ingrese su CUM">
                    </div>
                    <div class="form-check">
                    </div>
                    <center><button type="submit" class="btn btn-success" name="actualizar"
                            value="Actualizar">Actualizar</button></center>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
