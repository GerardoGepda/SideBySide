...
if (isset($_GET['id'])) {
    ...
    $consulta2 = $pdo->prepare("SELECT reu.ID_Reunion, alu.ID_Alumno , alu.Nombre ,
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="Modelo/ModeloReunion/SubirListaPDF.php" enctype="multipart/form-data">
                                ...
                                <div id="usuario">
                                    ...
                                    <div class="custom-file">
                                        <div class="custom-file">
                                            <input type="file" name="archivo" id="archivo2" accept="application/pdf,application/vnd.ms-excel" class="custom-file-input" required />
                                            <label class="custom-file-label" for="customFileLang" data-browse="Buscar">Seleccionar Archivo</label>
                                        </div>
                                    </div>

                                    <input type="hidden" name="idtaller" id="idtaller" value="<?php echo $fila['ID_Reunion']; ?>" />
                                    <br><br>
                                    <div id="alerta4"></div>
                                    <input type="submit" name="crear" id="crear" class="btn btn-primary btn-rounded btn-block my-4 waves-effect z-depth-0" value="Subir Documento" />
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="Modelo/ModeloReunion/CrearHorario.php">
                                <input type="hidden" name="idreunion" id="idreunion" value="<?php echo $fila['ID_Reunion']; ?>" />
                                ...
                                <div class="col">
                                    <div class="md-form">
                                        <input type="time" id="horafinalizar" name="horafinalizar" class="form-control" required>
                        ...
                        <div class="modal-footer">
                            <input class="btn btn-primary btn-rounded" type="submit" name="Guardar_Datos" value="Crear Horario" id="Guardar_Datos">
                            <button type="button" class="btn btn-dark" data-dismiss="modal">Cerrar</button>
                        </div>
                        </form>
                    </div>
    ...
    <div class="card">
        <h5 class="card-header" style="color: black;">Lista De Asistencia
            <span class="float-right">
                ...
                ?>
                <td>
                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#universidades"> <i class='fas fa-university'></i>Universidades</button>
                    ...
                    <table id="tableUser2" class="table table-hover table-sm table-bordered table-fixed">
                        ...
                        <tbody>
							...
							<th>" . $fila2['telefono'] . "</th>";
                                    ...
                                    if ($fila2['Tipo'] == 'Sesión individual' or $fila2['Tipo'] == 'Otro') {
                                        # code... horainicio y horafin
                                        echo "<th>" . $fila2['horainicio'] . "-" . $fila2['horafin'] . "</th>";
                                    } else {
                                        echo "<th>" . $fila2['HorarioInicio'] . "</th>";
                                    }
                                    echo "
							<th>" . $asiste . "</th>
                                        ...
                                        <table id="tableUser" class="table table-bordered">
											...
											<tr class='table-light'>
                                                ...
                                                <th>" . $fila3['HorarioFinalizado'] . "</th> ";
                                                        ...
                                                        echo "<td><a href='Vistas/VistaReunion/ActualizarHorario.php?id=" . $fila3['IDHorRunion'] . "&id2=" . $id . "'  class='fas fa-pencil-alt  btn btn-success'></a> </td>
