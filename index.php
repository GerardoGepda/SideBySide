...
<body style="background-color: #2D2D2E;">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner ">
          <div class="carousel-item active ">
            <img class=" img-fluid" src="img/fondologin.jpg" alt="First slide" style="height: 650px; width: 1000px; ">
          </div>
          <div class="carousel-item">
            <img class=" img-fluid" src="./SuperUsuario/img/foto3.JPG" alt="Second slide" style="height: 650px; width: 1000px; ">
          </div>
          <div class="carousel-item">
            <img class=" img-fluid" src="./SuperUsuario/img/Super2slider.jpg" alt="Third slide" style="height: 650px; width: 1000px;">
          </div>
        </div>
  ...
  <br><br>
  <div class="footer-copyright py-3" style="background: black; margin-top: -96px; width: 100%;">
