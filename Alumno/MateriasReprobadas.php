...
<div class="container-fluid text-center">
  ...
  <div>
    <div>
          ...
          <div class="col-sm" style="color: #343434;">
            ...
            <div class='centerTable '>
              <table id="makeEditable" class="thead-dark">
                <h3 class="card-header h3s bg-light">Lista de materias Reprobadas</h3>
      ...
      ON IC.Id_InscripcionC=IM.Id_InscripcionC WHERE M.idExpedienteU = ? AND IM.estado = 'Reprobada' ");
                  ...
                  if ($consulMaterias->rowCount() >= 1) {
                    ...
                    echo "<tr><td colspan='6'>No hay ninguna asignatura reprobada.</td></tr>";
                  } //fin de else-if 
                  ?>
                </tbody>
