...
<br>
<input type="number" min="0" max="40" name="cantidad"  required title="Debes ingresar un formato en numeros" style="background-color: #c7c7c7;width: 150px; border-radius: 8px; border-color: white;" id="horasSoc">
