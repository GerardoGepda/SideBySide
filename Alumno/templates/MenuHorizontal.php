    ...
    <div id="mySidepanel" class="sidepanel" style="background-color: #BE0032;">
        ...
        <div class="dark border-right" id="sidebar-wrapper">
            <div class="sidebar-heading justify-content-center align-items-center">
                <center>
                    <img src="../img/imgUser/<?php echo $_SESSION['Foto']?>" class="rounded-circle"
                        class="img-responsive" style="width: 100px; height: 100px">
                </center>
                <hr>
                <b>
                    <p style="font-size: 10px; text-align: center; "><?php echo $_SESSION['Email'] ?></p>
                </b>
            </div>
     ...
     ?>
                    <li><a href="AlumnoReuniones.php" class="list-group-item list-group-item-action"><i
                                class="fas fa-clipboard-list"></i> Reuniones</a></li>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="collapseExample2">
                            <ul>
                                <li><a href="expedienteU.php" class="list-group-item list-group-item-action"><i
                                            class="fas fa-user-graduate"></i> Expediente</a></li>
...
?>
                    ...
                    <li><a href="preguntasfrecuentes.php" class="list-group-item list-group-item-action"><i
                                class="far fa-question-circle"></i> Preguntas Frecuentes</a></li>
                    <?php 
$correo = $_SESSION['Email'];
            ...
            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                                    ...
                                    if (EstadoSolicitud == 'Aprobado') {
                                        if (estado == 'Visto') {
                                            $("#notis").append('<div class="notificacion">' +
                                                '<a class="dropdown-item noti" href="DetallesSolicitudCampoLaboral.php?id=' +
                                                ...
                                                nombre +
                                                ' ha solicitado un cambio de estado.</span>' +
                                                '</div>');
                                        } else {
                                            $("#notis").append('<div class="notificacion">' +
                                                '<a class="dropdown-item noti" href="DetallesSolicitudCampoLaboral.php?id=' +
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown campana" role="button"
                        ...
                        style="border-style: none;color: white;">
