...
{ 
  $dataMInscrp = $_COOKIE['InscrpCiclo'];
  //variables para la incripcion de materias
	$idMateria = $_POST['materia'];
	$Matricula = $_POST['matricula'];
  //$CicloU=$_POST['ciclo'];
  $idExpedienteU = $dataMInscrp['idExpdt'];
  $Id_InscripcionC = $dataMInscrp['idInscrip'];

  //creacion de codigo aleatorio para incripcion de materia
  $MI="MI";
  $n1="-";
  $n2=mt_rand(1,9);
  $n3=mt_rand(1,9);
  ...
  //Generamos el id con 5 numeros random
  ...
  while ($comp == 1) {
    ...
    if ($existe>=1) {
      ...
      $n5=mt_rand(1,9);
      $n6=mt_rand(1,9);
      // Si existe generamos otro id con 5 numeros aleatorios
      $InscripcionMateria= $MI."".$n1."".$n2."".$n3."".$n4."".$n5."".$n6;
    }else {
      $comp=2;
    }
  ...
  //consulta para insertar nueva incripcion de materia
