  ...
  if ($tamañoarchivo <= 5000000) {
    ...
    if (copy($rutaarchivo, $destino)) {
      ...
      try {
        ...
        $consulta2->execute([":Comprobante" => $nombrearchivo, ":ID_HSociales" => $id, ":CantidadH" => $cantidad, ":FechaInicio" => $fecInicio, ":FechaFinal" => $fecFin, ":Encargado" => $encargado, ":Descripcion" => $descripcion, ":ID_Ciclo" => $ciclo, ":ID_Alumno" => $IDAlumno]);
