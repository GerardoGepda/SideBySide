...
<link rel="stylesheet" type="text/css" href="../CoachReuniones/css/Renovacion.css">
  <style type="text/css">
     .modal-content{
...
<tbody>
 ...
 $n=1;
    ...
    <td>
<div class="btn-grupo">
    <button type="button" value="../CoachReuniones/<?php echo $datos['direccion']?>" class="btn btn-warning" data-toggle="modal" data-target="#mostrarPDF"   id="direccion<?php echo $n ?>" ><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
