            ...
            <div class="container" style="background: white; "><br>
                ...
                <div class="col-sm" style="color: #343434;">
                    ...
                    <span class="float-right">
                        <button type='button' class='btn btn-danger' data-toggle='modal' data-target='#ModalMateria' style="border-radius: 20px; border: 2px solid #9d120e; width: 100px;height: 50px; background-color: #9d120e; color:white;">
                            <img src="../img/add.png" width="25px" height="25px"><br>
                    ...
                    <br> <br><br>
                    <table id="pensum" class="table table-hover table-sm table-bordered table-fixed">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="Modelo/ModeloMaterias/GuardarMaterias.php" method="POST" accept-charset="utf-8">
                        ...
                        <center><input style="border-radius: 20px;  border: 2px solid #9d120e; width: 200px;height: 38px;  background-color: #9d120e;  color:white;" type="submit" name="Guardar_Materia" value="Agregar Materia " id="Guardar_Materia"></center>
                    </form>
                </div>
            </div>
        </div>
