                    ...
                    <div class="centerTable">
                        <table class="table-responsive mx-auto w-75">
                            ...
                            <tbody>
                                ...
                                $consulMaterias = $pdo->prepare("SELECT IM.Id_InscripcionM, IM.nota,IM.idMateria,IM.matricula, M.nombreMateria, IM.estado, IC.cicloU, M.idExpedienteU from materias M INNER JOIN inscripcionmateria IM ON IM.idMateria= M.idMateria INNER JOIN inscripcionciclos IC ON IC.Id_InscripcionC=IM.Id_InscripcionC WHERE M.idExpedienteU = $idExpedienteU ");
